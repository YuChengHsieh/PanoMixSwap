...
class ACE(nn.Module):
    ...
    def create_gamma_beta_fc_layers(self):
        ...
        self.fc_mu35 = nn.Linear(style_length, style_length)
        self.fc_mu36 = nn.Linear(style_length, style_length)
        self.fc_mu37 = nn.Linear(style_length, style_length)
        self.fc_mu38 = nn.Linear(style_length, style_length)
        self.fc_mu39 = nn.Linear(style_length, style_length)
        """
