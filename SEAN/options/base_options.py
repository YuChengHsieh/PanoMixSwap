...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='structure3D_7labels', help='name of the experiment. It decides where to store samples and models')

        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./SEAN/checkpoints', help='models are saved here')
        ...
        parser.add_argument('--preprocess_mode', type=str, default='', help='scaling and cropping of images at load time.', choices=("resize_and_crop", "crop", "scale_width", "scale_width_and_crop", "scale_shortside", "scale_shortside_and_crop", "fixed", "none"))
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/media/public_dataset/structured3D/structure_panoDR')
        parser.add_argument('--dataset_mode', type=str, default='structure3D')
